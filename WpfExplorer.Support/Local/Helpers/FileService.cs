...
public class FileService
{
    ...
    {
        List<FolderInfo> roots = [ CreateFolderInfo(1, "Download", IconType.ArrowDownBox, _directoryManager.DownloadDirectory),
    ...
    public static void RefreshSubdirectories(FolderInfo parent)
    {
